...
<html class="">
    ...
    <body style="background:#FFFFFF">
        <nav style="border-bottom:solid 2px red;" class="navbar navbar-red header navbar-fixed-top navbar-inverse" role="navigation">
            <div class="container">
...
<div class="row" style="padding:0;">
<div class="col-lg-4" >
<a  href="<?php echo SITE_URL;?>"><img title="<?php echo $TS_SITE['base'][site_title];?>" src="<?php echo SITE_URL;?>uploadfile/logo/<?php echo $TS_SITE['base'][logo];?>" alt="<?php echo $TS_SITE['base'][site_title];?>" width="190" height="40" />
</a>
</div>
<div class="col-lg-4">
...
<div class="appnav appnavheader" style="height:40px;margin-top:10px;">
<div class="container" >
<ul>
