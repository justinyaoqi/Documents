    ...
    <nav class="navbar navbar-blue header navbar-fixed-top navbar-inverse" role="navigation">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo SITE_URL;?>"><img title="<?php echo $TS_SITE['base'][site_title];?>" src="<?php echo SITE_URL;?>uploadfile/logo/<?php echo $TS_SITE['base'][logo];?>" alt="<?php echo $TS_SITE['base'][site_title];?>" width="190" height="40" />
                </a>
            </div>
            <ul class="nav navbar-nav hidden-xs">
                <li class="active"><a href="<?php echo SITE_URL;?>">首页</a>
                </li>
            ...
            <ul class="nav navbar-nav navbar-right navbar-collapse collapse" id="header-user">
                ...
                <li class="dropdown" style="width:200px;text-align:right;">
                    ...
                    <ul class="dropdown-menu" role="menu">
                        ...
                        <?php } ?>
                        <li><a href="<?php echo tsurl('home','theme')?>">换肤</a>
                        </li>
    ...
    <div class="appnav appnavheader">
        <div class="container">
            <ul>
                ...
                <li <?php if($app==$key) { ?>class="select" <?php } ?>><a href="<?php echo SITE_URL;?>"><?php echo $item;?></a>
                </li>
                <?php } else { ?>
