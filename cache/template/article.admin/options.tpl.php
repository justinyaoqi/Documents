...
<tr><td>文章是否审核：</td><td><input type="radio" name="option[isaudit]" value="0" <?php if($strOption['isaudit']=='0') { ?>checked<?php } ?>  />不审核 <input type="radio" name="option[isaudit]" value="1" <?php if($strOption['isaudit']=='1') { ?>checked<?php } ?> />审核</td></tr>
