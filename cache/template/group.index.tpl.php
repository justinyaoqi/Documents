            ...
            <div class="bbox">
                ...
                <div style="background-color: #F5F5F5;">
                    <ul>
                        ...
                        <li style="height: 90px;padding: 5px;border-bottom: solid 1px silver;overflow: hidden;">
                            <div style="clear:both; font-size: 16px; ">
                                <span class="glyphicon glyphicon-search" style="margin-left: 20px;"></span><span style="margin-left: 10px;"><a href=""><?php echo $item['catename'];?></a></span>
                            </div>
                            <div style="clear: both;font-size: 14px;padding: 5px 20px;" class="">
                                <ul style="">
                                    <?php foreach((array)$item['two'] as $tkey=>$titem) {?>
                                    <li style="float: left;text-align: center;line-height: 24px;padding: 2px;"><a href=""><?php echo $titem['catename'];?></a>
                                    </li>
                                    <?php }?>
                                </ul>
                            </div>
            ...
            <div>
                <div class="bbox">
                    ...
                    <div class="media" style="margin-top: 0;">
                        <div>
                            <h5><span class="label label-success"><?php echo $item['tag'][0]['tagname'];?></span><a href="<?php echo tsurl('group','show',array('id'=>$item['groupid']))?>"><?php echo $item['group']['groupname'];?></a></h5>
                        </div>
                        ...
                        <div style="font-size: 12px;color:#666;">
                            <span style=""><span class="glyphicon glyphicon-user"></span><span> <a href="" style="color:#666;"><?php echo $item['user']['username'];?></a></span></span>

                            <span style="margin-left: 20px;"><span style="line-height: 10px;font-size: 12px;" class="glyphicon glyphicon-comment"></span><span><?php echo $item['count_comment'];?></span>
