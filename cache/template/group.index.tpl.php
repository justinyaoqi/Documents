                ...
                <ul>
                    ...
                    <li style="height: 90px;padding: 4px;border-bottom: solid 1px silver;overflow: hidden;">
                        <div style="clear:both; font-size: 16px; ">
                            <span class="glyphicon glyphicon-search" style="margin-left: 20px;font-size:12px;"></span><span style="margin-left: 10px;"><a href=""><?php echo $item['catename'];?></a></span>
                        </div>
                        <div style="clear: both;font-size: 14px;padding: 5px 20px;" class="">
                            <ul style="">
                                <?php foreach((array)$item['two'] as $tkey=>$titem) {?>
                                <li style="float: left;text-align: center;line-height: 24px;padding: 2px;"><a title="<?php echo $titem['catename'];?>" href=""><?php echo $titem['catename'];?></a>
                            </li>
                            <?php }?>
                        </ul>
                    </div>
