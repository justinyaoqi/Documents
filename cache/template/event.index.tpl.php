...
<img src="<?php if($arrEvent[0][poster]) { ?><?php echo SITE_URL;?><?php echo tsXimg($arrEvent[0][poster],'event',96,96,$arrEvent[0][path],1)?><?php } else { ?><?php echo SITE_URL;?>uploadfile/event/event_dft.png<?php } ?>"></a>
...
地点：<?php echo $arrEvent[0][address];?><br>
发起人：<a href="<?php echo SITE_URL;?><?php echo tsurl('user','space',array(userid=>$arrEvent[0][user][userid]))?>"><?php echo $arrEvent[0][user][username];?></a> <br>
...
<img class="actimgs" src="<?php if($item['poster']) { ?><?php echo SITE_URL;?><?php echo tsXimg($item['poster'],'event',48,48,$item['path'],1)?><?php } else { ?><?php echo SITE_URL;?>uploadfile/event/event_dft.png<?php } ?>" width="48"></a>
<div class="evtdesc">
<?php echo $item['time_start'];?> - <?php echo $item['time_end'];?><br><a href="<?php echo SITE_URL;?><?php echo tsurl('user','space',array(userid=>$item['user'][userid]))?>"><?php echo $item['user'][username];?></a><br><?php echo $item['count_userdo'];?>人参加 &nbsp; <?php echo $item['count_userwish'];?>人感兴趣<br>
</div></li>
<?php } ?>
<?php }?>
