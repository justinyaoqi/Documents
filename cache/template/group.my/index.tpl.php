...
<li role="presentation" class="active"><a href="<?php echo tsurl('group','my',array('my'=>'index'))?>">加入的小组</a></li>
<li role="presentation"><a href="<?php echo tsurl('group','my',array('my'=>'created'))?>">创建的小组</a></li>
</ul>
