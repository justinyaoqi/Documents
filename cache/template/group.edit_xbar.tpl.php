...
<li role="presentation" <?php if($ts=="icon") { ?>class="active"<?php } ?>><a href="<?php echo tsurl('group','edit',array('groupid'=>$strGroup['groupid'],'ts'=>'icon'))?>">小组图标</a></li>
...
<li role="presentation" <?php if($ts=="cate") { ?>class="active"<?php } ?>><a href="<?php echo tsurl('group','edit',array('groupid'=>$strGroup['groupid'],'ts'=>'cate'))?>">小组分类</a></li>
