...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1423988556, '3', './data/template/3_3_common_header_forum_index.tpl.php', './template/sxp_keji_k2', 'common/header_forum_index')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1423988556, '3', './data/template/3_3_common_header_forum_index.tpl.php', './template/sxp_keji_k2', 'common/header_forum_index')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1423988556, '3', './data/template/3_3_common_header_forum_index.tpl.php', './template/sxp_keji_k2', 'common/header_forum_index')
;?>
